...
<html lang="en-US">
    <head prefix="og: http://ogp.me/ns# book: http://ogp.me/ns/book#">
        ...
        {% block style %}
        <link rel="stylesheet" href="http://skyinlayerblog.qiniudn.com/style.css">
        {% endblock %}
        {% endblock %}
    </head>
    <body>
        ...
        <script src="http://cdn.staticfile.org/ace/1.1.3/mode-javascript.js"></script>
        <script src="{{ staticBase }}/jsrepl/jsrepl.js" id="jsrepl-script"></script>
        <script src="http://skyinlayerblog.qiniudn.com/app.js"></script>
        {% endblock %}
    </body>
</html>
