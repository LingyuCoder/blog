<div class="book-summary">
    ...
    <ul class="summary">
        <li>
            <a href="{{ githubHost }}{{ githubAuthor }}" target="blank">关于作者</a>
        </li>
        <li>
            <a href="{{ githubHost }}{{ githubId }}/issues" target="blank">问题和讨论</a>
        </li>
        <li>
            <a href="{{ githubHost }}{{ githubId }}/edit/master/{{ _input }}" target="blank">编辑和提交</a>
        </li>
        <li class="divider"></li>
        <li data-level="0" data-path="index.html">
            <a href="{{ basePath }}/"><i class="fa fa-check"></i> 简介</a>
        </li>
