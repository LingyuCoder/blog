...
![WebRTC浏览器兼容性from caniuse.com](http://skyinlayer.com/img/WebRTC/1.png)
...
![JSEP架构](http://skyinlayer.com/img/WebRTC/2.png)
...
![整合了ICE框架的WebRTC应用架构](http://skyinlayer.com/img/WebRTC/3.png)
